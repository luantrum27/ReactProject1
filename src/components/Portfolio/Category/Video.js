...
import item6 from '../../../assets/image/item1.jpg'
import item2 from '../../../assets/image/item2.jpg'
import item8 from '../../../assets/image/item3.jpg'
...
function Video() {
    ...
    return (
        <div className='portifolio-wrapper'>
            ...
            {
                popup && <Popup title='Project' project='website' client='The Luan' language='HTML, CSS, Javascript' preview='http://localhost:3000'/>
            }
        </div>
    )
}
